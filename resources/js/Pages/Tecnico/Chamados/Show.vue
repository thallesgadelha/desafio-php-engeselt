    ...
    <AppLayout title="Chamado">
        ...
        <div class="max-w-6xl mx-auto p-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
                ...
                <Link :href="route('tecnico.chamados.index')"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
                ...
                <div class="bg-white shadow rounded p-4 border border-gray-100 hover:shadow-md transition">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea v-model="respostaForm.mensagem" rows="3"
...
const adicionarResposta = () => {
    if (!respostaForm.mensagem.trim()) return;

    respostaForm.post(route('tecnico.chamados.responder', props.chamado.id), {
        preserveScroll: true,
        onSuccess: () => {
            respostaForm.reset();
